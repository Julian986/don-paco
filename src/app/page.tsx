...
const products = [
  { slug: "manta-refrigerante-clasicas", name: "Manta Refrigerante Clasicas", price: "$33.900", cash: "$30.510" },
  { slug: "mantita-polar", name: "Mantita Polar", price: "$11.900", cash: "$10.710" },
  { slug: "colchoneta-chipre", name: "Colchoneta Chipre", price: "$32.670", cash: "$29.403" },
  { slug: "rascador-alfombra-de-gato", name: "Rascador Alfombra de Gato", price: "$13.000", cash: "$11.700" },
  { slug: "colchoneta-fuji-chica", name: "Colchoneta Fuji Chica", price: "$29.290", cash: "$26.361" },
  { slug: "moises-coqueton-jean-chico", name: "Moises Coqueton Jean Chico", price: "$57.100", cash: "$51.390" },
  { slug: "moises-coqueton-jean-grande", name: "Moises Coqueton Jean Grande", price: "$74.990", cash: "$67.491" },
  { slug: "moises-tulum-grande", name: "Moises Tulum Grande", price: "$80.850", cash: "$72.765" },
];
