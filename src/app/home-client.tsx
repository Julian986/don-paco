...
export default function HomeClient({
  ...
  const filteredListing = useMemo(() => {
    if (selectedCategory === "Todas") return initialListing;
  ...
  }, [selectedCategory, initialListing]);
  ...
  return (
    <main className="min-h-screen bg-white text-[#3f3f3f]">
      ...
      <HeroBanner
        bannerTitle={site.bannerTitle}
        bannerSubtitle={site.bannerSubtitle}
        bannerLead={site.bannerLead}
        cashDiscountLabel={site.cashDiscountLabel}
      />
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 py-16 md:grid-cols-[1.5fr_1fr_1fr_1fr_1fr] md:gap-8">
          <div>
            <div className="mb-6 inline-flex items-center gap-2">
              <PawIcon className="h-7 w-7 text-[#029f9c]" />
              <span className="text-lg font-black uppercase tracking-wide text-[#4c4c4c]">{site.storeName}</span>
            </div>
