/** Maps de imágenes por slug de variante y por slug de grupo (generado desde products.ts). */
...
export const productGroupImageByGroupSlug: Partial<Record<string, string>> = {
